...
public class MinioUtil {
     ...
     */
    @SneakyThrows
    public List<Object> listBucketNames() {
        Iterable<Result<Item>> myObjects = minioClient.listObjects(minioConfig.getBucketName());
     ...
     * @param file
     */
    public List<String> upload(String bucketName, MultipartFile[] file) throws Exception{
    ...
    public void downloadFile(String bucketName, String fileName, String originalName, HttpServletResponse response) {
        try {
            ...
            if (StringUtils.isNotNull(originalName)) {
